	...
	<v-card class="pa-2">
		<div class="d-flex justify-center">
			<div class="grid">
				...
				<div class="borderTable w-100">
					<div class="styledRow">
						...
						<div>
							<div class="styledRow"><input v-model="c.survival.dodge" type="checkbox"><div class=text-caption>Dodge</div></div>
							<div class="styledRow"><input v-model="c.survival.encourage" type="checkbox"><div class=text-caption>Encourage</div></div>
							<div class="styledRow"><input v-model="c.survival.surge" type="checkbox"><div class=text-caption>Surge</div></div>
							<div class="styledRow"><input v-model="c.survival.dash" type="checkbox"><div class=text-caption>Dash</div></div>
							<div class="styledRow"><input v-model="c.survival.endure" type="checkbox"><div class=text-caption>Endure</div></div>
						</div>
					</div>
				</div>
				<div class="borderTable w-100">
			...
			<div>
				...
				<v-divider />
				<div class="styledRow">
					<div class="square" style="background-color: rgb(73, 73, 255);"></div><KDMIcon icon="Book" :size="16"/> <span class="text-caption">Age</span>
					<div class="styledRowDense">
						<div class="square" style="background-color: rgb(73, 73, 255);"></div>
						<div class="square" style="background-color: rgb(73, 73, 255);"></div>
					</div>
				...
				<div class="borderTable w-100 d-flex gap-1 align-center">
					...
					<div>
						...
						<div class="styledRow">
							<div class="square" style="background-color: rgb(73, 73, 255);"></div><span class="text-caption">Specialist</span>
							<div class="styledRowDense">
								<div class="square" style="background-color: rgb(73, 73, 255);"></div>
								<div class="square" style="background-color: rgb(73, 73, 255);"></div>
							</div>
				...
				<div class="d-flex">
					<div class="borderTable">
						...
						<div class="styledRow">
							<div class="square" style="background-color: rgb(73, 73, 255);"></div><span class="text-caption">Bold</span>
							<div class="styledRowDense">
								<div class="square" style="background-color: rgb(73, 73, 255);"></div>
								<div class="square" style="background-color: rgb(73, 73, 255);"></div>
							</div>
						...
						<table>
							<tr>
								...
								<td>									
									<div style="font-size: 10px;">
										<span style="font-size: 12px;">Stalwart</span>:
							...
							<tr>
								...
								<td>									
									<div style="font-size: 10px;">
										<span style="font-size: 12px;">Prepared</span>:
							...
							<tr>
								...
								<td>									
									<div style="font-size: 10px;">
										<span style="font-size: 12px;">Matchmaker</span>:
										Spend 1 endeavor<br>
					...
					<div class="borderTable">
						...
						<div class="styledRow">
							<div class="square" style="background-color: rgb(73, 73, 255);"></div><span class="text-caption">Insight</span>
							<div class="styledRowDense">
								<div class="square" style="background-color: rgb(73, 73, 255);"></div>
								<div class="square" style="background-color: rgb(73, 73, 255);"></div>
							</div>
						...
						<table>
							...
							<tr>
								...
								<td>									
									<div style="font-size: 10px;">
										<span style="font-size: 12px;">Tinker</span>:
				...
				<div>
					<div class="styledRow">
						Fighting Arts (Max 3)
						<v-btn @click="c.fightingArts.values.push('')" color="success" size="18">
						   <v-icon>mdi-plus</v-icon>
						</v-btn>	
						<div class="styledRowDense">
							<v-checkbox v-model="c.fightingArts.locked" density="compact" hide-details/>
							<span class="text-caption styledRow">
								<KDMIcon icon="Lock" :size="16" />Cannot use Fighting Arts
							</span>
						</div>
					</div>
					<div v-for="(v, i) in c.fightingArts.values" class="styledRow text-caption">
					...
					<div class="styledRow">
						Disorders (Max 3)
						<v-btn @click="c.disorders.values.push('')" color="success" size="18">
						   <v-icon>mdi-plus</v-icon>
						</v-btn>	
					</div>
					<div v-for="(v, i) in c.disorders.values" class="styledRow text-caption">
					...
					<div class="styledRow">
						...
						<v-btn @click="c.abilitiesNImpairments.values.push('')" color="success" size="18">
						   <v-icon>mdi-plus</v-icon>
						</v-btn>	
						<div class="styledRowDense">
							<v-checkbox v-model="c.abilitiesNImpairments.locked" density="compact" hide-details/>
							<span class="text-caption styledRow">
								<KDMIcon icon="Lock" :size="16" />Skip Next Hunt
							</span>
						</div>
					</div>
					<div v-for="(v, i) in c.abilitiesNImpairments.values" class="styledRow text-caption">
					...
					<div class="styledRow">
						Once Per Lifetime
						<v-btn @click="c.oncePerLifetime.values.push('')" color="success" size="18">
						   <v-icon>mdi-plus</v-icon>
						</v-btn>	
						<div class="styledRowDense">
							<v-checkbox v-model="c.oncePerLifetime.locked" density="compact" hide-details/>
							<span class="text-caption styledRow">
								<KDMIcon icon="Lock" :size="16" />Reroll used
							</span>
						</div>
					</div>
					<div v-for="(v, i) in c.oncePerLifetime.values" class="styledRow text-caption">
		...
		<div class="d-flex justify-center">
			...
			<div>
				<div class="styledRow">
					Parents
					<v-btn @click="c.family.parents.push('')" color="success" size="18">
						<v-icon>mdi-plus</v-icon>
					</v-btn>	
				</div>
				<div v-for="(v, i) in c.family.parents" class="styledRow text-caption">
				...
				<div v-for="(v, i) in c.family.childs" class="styledRow text-caption">
			...
			<div>
				Notes
				<textarea v-model="c.notes" cols="33" rows="5"></textarea>
			</div>
		</div>
	</v-card>
</template>
...
.checkT2{
	outline: 3px solid rgb(73, 73, 255);
}
.checkT3{
	outline: 3px solid rgb(255, 247, 0);
}
.square{
	min-width: 8px;
	min-height: 8px;
